...
spec: # v1.PodSpec
  containers:
    image: "ghcr.io/edgelesssys/contrast/coordinator"
    name: coordinator
    env:
...
to rerun `contrast generate` to update the policy to allow the environment change.
...
TODO: actually a policy problem?
